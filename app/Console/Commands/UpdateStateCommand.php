...
use App\Mail\CertificatesExpired;
use App\Certificate;
...
class UpdateStateCommand extends Command{
  ...
  private function sendExpiringMail(){
    Mail::to(['oyekunmi@gmail.com','captmodey@yahoo.com','captainmodey@gmail.com','ruth.nwigwe@c-ileasing.com', 'Felix.urangwung@c-ileasing.com', 'blessing.ogujiofor@c-ileasing.com'])
    ->send(new CertificatesExpiring($this->expiring));
  }

  private function sendExpiredMail(){
    Mail::to(['oyekunmi@gmail.com','captmodey@yahoo.com','captainmodey@gmail.com','ruth.nwigwe@c-ileasing.com', 'Felix.urangwung@c-ileasing.com', 'blessing.ogujiofor@c-ileasing.com'])
    ->send(new CertificatesExpired($this->expired));
  }
